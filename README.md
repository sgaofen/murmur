...
- [Mac 安装视频](https://github.com/sgaofen/murmur/releases/download/v0.3.16/Murmur_macOS_install_tutorial.mp4)
- [Windows 微信 安装视频](https://github.com/sgaofen/murmur/releases/download/v0.3.16/Murmur_Windows_install_tutorial.mp4)
- [Windows QQ 安装视频](https://github.com/sgaofen/murmur/releases/download/v0.3.16/Murmur_QQ_install_tutorial.mp4)
...
- 推荐下载：`Murmur_0.3.16_x64-setup.exe`
- 不推荐普通用户下载：`Murmur_0.3.16_x64_en-US.msi`
...
1. 下载 `Murmur_0.3.16_x64-setup.exe`。
2. 双击安装。
